...
if(Mage::getConfig()->getNode('modules/Sm_papa')){
	$_config	=	Mage::helper('papa/data')->get($attributes);
}
// enable Cpanel
...
$_params->set('googleWebFontWeight',$_config['google_font_font_weight']);
// Respnsive menu
...
global $var_yttheme;
$var_yttheme = new YtTheme('sm_papa', $_params, $paramscookie);
?>
